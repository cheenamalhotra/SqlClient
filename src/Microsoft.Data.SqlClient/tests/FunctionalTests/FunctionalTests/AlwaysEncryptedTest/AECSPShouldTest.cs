...
using Xunit;
using Xunit.Sdk;
using static Microsoft.Data.SqlClient.FunctionalTests.TestFixtures;

namespace Microsoft.Data.SqlClient.FunctionalTests
{
    public class AECspShouldTest : IClassFixture<CertificateFixture>
    {
        ...
        public void TestCustomKeyProviderListSetter()
        {
            ...
            customProviders.Add(new KeyValuePair<string, SqlColumnEncryptionKeyStoreProvider>(@"DummyProvider", new AEDummyKeyStoreProviderTest()));
            ...
            customProviders.Add(new KeyValuePair<string, SqlColumnEncryptionKeyStoreProvider>(@"", new AEDummyKeyStoreProviderTest()));
    ...
    public class AECspUnixShouldTest
    {
        [Fact]

...
namespace Microsoft.Data.SqlClient.Tests.AlwaysEncryptedTests
{
    public static class Utility
    {
        ...
        internal static X509Certificate2 CreateCertificate()
        {
            ...
            X509Certificate2 certificate = X509CertificateLoader.LoadPkcs12(certificateRawBytes, "", X509KeyStorageFlags.PersistKeySet |  X509KeyStorageFlags.UserKeySet);
#else
            X509Certificate2 certificate = new(certificateRawBytes, "", X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.UserKeySet);
#endif            

...
namespace Microsoft.Data.SqlClient.Tests
{
    public class SqlConnectionBasicTests
    {
        ...
        public async Task PreLoginEncryptionExcludedTest()
        {
            ...
            Assert.Contains("A connection was successfully established with the server, but then an error occurred during the pre-login handshake", ex.Message, StringComparison.OrdinalIgnoreCase);
        }

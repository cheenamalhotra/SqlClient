...
using Microsoft.Data.SqlClient.ManualTesting.Tests.Setup;
using Xunit;

namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    [PlatformSpecific(TestPlatforms.Windows)]
    public class AEEnd2EndSmokeTest : IClassFixture<SQLSetupStrategyCertStoreProvider>, IDisposable
    {
        private SQLSetupStrategyCertStoreProvider fixture;

        private readonly string tableName;

        public AEEnd2EndSmokeTest(SQLSetupStrategyCertStoreProvider fixture)
        {

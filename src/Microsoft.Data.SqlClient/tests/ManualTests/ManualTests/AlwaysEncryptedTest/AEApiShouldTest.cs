...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    ...
    public class AEApiShouldTest : IClassFixture<SQLSetupStrategyCertStoreProvider>, IDisposable
    {
        private SQLSetupStrategyCertStoreProvider fixture;

        private readonly string tableName;

        public AEApiShouldTest(SQLSetupStrategyCertStoreProvider fixture)
        {

...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    ...
    public class AEBulkCopyTest : IClassFixture<SQLSetupStrategyCertStoreProvider>, IDisposable
    {
        private SQLSetupStrategyCertStoreProvider fixture;

        private readonly string tableName;

        public AEBulkCopyTest(SQLSetupStrategyCertStoreProvider fixture)
        {

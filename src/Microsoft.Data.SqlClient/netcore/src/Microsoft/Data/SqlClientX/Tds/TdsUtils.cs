...
namespace Microsoft.Data.SqlClientX.Tds
{
    internal class TdsUtils
    {
        ...
        internal static void FireInfoMessageEvent(TdsContext context, SqlConnectionX connection, SqlCommand command, SqlError error)
        {
            string serverVersion = null;

            Debug.Assert(connection != null && context.SqlConnector.OwningConnection == connection);
            ...
            SqlException exc = SqlException.CreateException(new() { error}, serverVersion, context, innerException: null, batchCommand: command?.GetCurrentBatchCommand());

            connection.OnInfoMessage(new SqlInfoMessageEventArgs(exc), out _);
        }
        ...
        internal static void ThrowExceptionAndWarning(TdsContext tdsContext, SqlCommand command = null, bool callerHasConnectionLock = false)
        {
            ...
            SqlErrorCollection temp = tdsContext.TdsErrorWarningsState.GetFullErrorAndWarningCollection(out bool breakConnection);
            ...
            Debug.Assert(tdsContext.SqlConnector != null, "TdsUtils::ThrowExceptionAndWarning called with null SqlConnector!");
            ...
            if (exception != null)
            {
                ...
                tdsContext.SqlConnector.OnError(exception);

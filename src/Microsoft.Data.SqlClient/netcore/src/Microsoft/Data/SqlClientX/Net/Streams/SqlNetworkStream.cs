...
{
    /// <summary>
    /// This class extends NetworkStream to customize stream behavior for Managed networking implementation.
    /// </summary>
    internal sealed partial class SqlNetworkStream : NetworkStream
    {
        ...
        public SqlNetworkStream(Socket socket, bool ownsSocket) : base(socket, ownsSocket)
        {
        ...
        public override async ValueTask<int> ReadAsync(Memory<byte> buffer, CancellationToken cancellationToken = default)
        {
            ...
            {
                SqlClientEventSource.Log.TrySNITraceEvent(nameof(SqlNetworkStream), EventType.ERR, "Internal Exception occurred while reading data: {0}", args0: e?.Message);
                throw;
            }
            finally
            {

...
#pragma warning restore 618
        ...
        private bool TryOpenWithRetry(TaskCompletionSource<DbConnectionInternal> retry, bool isAsyncLogin, SqlConnectionOverrides overrides)
            => RetryLogicProvider.Execute(this, () => TryOpen(retry, isAsyncLogin, overrides));
        ...
        public void Open(SqlConnectionOverrides overrides)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (!(IsRetryEnabled ? TryOpenWithRetry(null, isAsyncLogin: false, overrides) : TryOpen(null, isAsyncLogin: false, overrides)))
                    {
